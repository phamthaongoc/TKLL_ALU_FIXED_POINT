...
HD_PWD='C:/Users/PTNgoc/DA_TKLL_ALU_FIXED_POINT/ALU_FIXED_POINT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapped.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wrapped.tcl -notrace
