...
HD_PWD='C:/Users/PTNgoc/DA_TKLL_ALU_FIXED_POINT/ALU_FIXED_POINT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapped.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrapped.tcl
