...
REM
REM Generated by Vivado on Tue Jan 06 14:07:01 +0700 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_wrapped_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_wrapped_vlog.prj -log xvlog.log
